...
<div class="right">
       ...
       <div class="search">
       <form method="get" action="${pageContext.request.contextPath}/listBill">
      ...
      <table class="providerTable" cellpadding="0" cellspacing="0">
          ...
          <c:forEach var="bill" items="${bills.list}" varStatus="status">
				<tr>
					<td>
		...
		<input type="hidden" id="totalPageCount" value="${bills.pages}"/>
			<c:import url="rollpage.jsp">
			<c:param name="totalCount" value="${bills.total}"/>
			<c:param name="currentPageNo" value="${bills.pageNum}"/>
			<c:param name="totalPageCount" value="${bills.pages}"/>
		</c:import>
  </div>
</section>
